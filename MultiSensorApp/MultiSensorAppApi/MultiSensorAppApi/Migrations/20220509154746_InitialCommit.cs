        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sensors_AlertLevels_AlertLevelId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sensors_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Function = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                    EmailAdress = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAcsess = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlertConfigurations_Sensors_SensorId",
                        column: x => x.SensorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertConfigurations_SensorId",
